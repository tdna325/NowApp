...
public class FragmentRiceGiaoNhanh extends Fragment {
    private View mRootView;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.activity_fragment_rice_giao_nhanh,container,false);

        ArrayList<Milk> arrayList = new ArrayList<>();
        ListView lv = (ListView) mRootView.findViewById(R.id.lv_giaonhanh);
        Milk gantoi1 = new Milk(R.drawable.rice1,R.drawable.checkmark,"Cơm Tấm Phương Trang","01 Hải Hồ, Quận Hải Châu, Đà Nẵng","⭐️ 4.8","\uD83D\uDD52 37min*2.5km","1 địa điểm khác >");
        Milk gantoi2 = new Milk(R.drawable.rice2,R.drawable.checkmark,"Bếp Của Ngoại - Yên Bái","136B Yên Bái, Quận Hải Châu, Đà Nẵng","⭐️ 4.7","\uD83D\uDD52 44min*13.2km","1 địa điểm khác >");
